    ...
    <div class="container-fluid m-0">
        <div class="row align-items-center width-100">
            ...
            <div class="position-absolute d-flex login">
                <div class="container position-absolute login_div d-flex flex-column align-items-center justify-content-center" style="width: 40em; padding-left:0; height:90vh">
                    <figure>
                        <img src="./assets/images/duenoVh.png" alt="">
                    </figure>
                    ...
                    <section class="d-flex">
                        <div class="mb-3">
                            ...
                            <input name="nombre" type="text" class="input-login inputOwn" id="nombre" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label" style="padding-left: 40px; font-size: 20px;">Apellidos</label>
                            <input name="apellido" type="text" class="input-login inputOwn" id="apellido">
                        </div>
                    </section>
                    <article>
                    <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label" style="padding-left: 14px; font-size:20px;">Cedula</label>
                            <input name="cedula" type="text" class="input-login input-car" id="cedula" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                        <label for="rol_dueno" class="form-label" style="padding-left: 14px; font-size:20px;">Tipo de cliente</label>
                            <select name="rol_dueno" id="rol_dueno" class="form-select input-login input-car" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input name="placa" type="text" class="input-login input-car" id="placa" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                        <label for="tipo_vehiculo" class="form-label" style="padding-left: 14px; font-size:20px;">Tipo del vehículo</label>
                            <select name="tipo_vehiculo" id="tipo_vehiculo" class="form-select input-login input-car" required>
                                <option value="">Seleccione</option>
